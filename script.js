...
function calculateMaxPossibleGpa() {
    let currentPoints = 0, earnedCredits = 0, attemptedCredits = 0;
    courses.forEach(c => { 
...
elements.calculateBtn.addEventListener("click", () => {
    ...
    let currentPoints = 0, attemptedCredits = 0, earnedCredits = 0;
    courses.forEach(c => { 
        currentPoints += c.grade * c.credits; 
        attemptedCredits += c.credits;
        if (c.grade > 0) earnedCredits += c.credits;
...
function calculateStats() {
    let totalPoints = 0, attemptedCredits = 0, earnedCredits = 0;
    courses.forEach(course => { 
